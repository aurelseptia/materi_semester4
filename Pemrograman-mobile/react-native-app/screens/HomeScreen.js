...
const products = [
  {
    ...
    price: 'Rp 150.000',
    image: require('../assets/petualang.jpg'),
  },
  {
    id: '2',
    name: 'Komik Sains Kuark',
    price: 'Rp 100.000',
    image: require('../assets/Komik_Sains_Kuark.jpg'),
  },
  {
    id: '3',
    name: 'Komik Si Juki Anak Kosan',
    price: 'Rp 50.000',
    image: require('../assets/sijuki.jpg'),
  },
];
...
export default function HomeScreen({ navigation }) {
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.subtitle}>KOMIK TERLARIS</Text>
      <FlatList
        data={products}
        horizontal
